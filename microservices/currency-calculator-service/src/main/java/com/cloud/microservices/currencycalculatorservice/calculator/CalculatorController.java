...
public class CalculatorController {
	...
	public ResponseEntity<CurrencyConversion> convertCurrency(@PathVariable("from") String from, @PathVariable("to") String to, @PathVariable("amount") BigDecimal amount){
